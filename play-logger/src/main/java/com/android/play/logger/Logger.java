package com.android.play.logger;
...
import com.android.play.logger.printer.LoggerPrinter;
import com.android.play.logger.printer.Printer;
import com.android.play.logger.strategy.FormatStrategy;
import com.android.play.logger.strategy.LogStrategy;
...
public final class Logger {
  ...
  public static void printer(@NonNull Printer printer) {
    Logger.printer = LoggerUtil.checkNotNull(printer);
  }

  public static void addLogAdapter(@NonNull LogAdapter adapter) {
    printer.addAdapter(LoggerUtil.checkNotNull(adapter));
  }
